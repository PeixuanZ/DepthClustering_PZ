# -*- coding: utf-8 -*-
"""
Created on Sun Apr 14 15:20:09 2019

@author: DELL-PC
"""

"""
Construct a depth based OPTICS
"""
import numpy as np
...
if __name__ == '__main__':
    ...
    Ordered, ReachDepth = optics1.fit(iris.data[:,0:2])
    optics1.plt_show(iris.data[:,0:2], iris.target, ReachDepth, Ordered, name=1)
    """
